// TEST WORKFLOW: Multiple Leads Processing
// Loads multiple test leads and processes them through all scoring modules

// Load the test leads data
const testLeads = {
  "test_leads": [
    {
      "lead_id": "LEAD_001",
...
// Return all test leads for processing
return testLeads.test_leads.map(lead => ({ json: lead }));
